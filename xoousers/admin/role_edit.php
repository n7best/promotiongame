...
if($_POST["act"] == 'add_role') 
{
	...
	if($ret_validate=="")	
	{
		$auxRole->edit_item($_POST, $c);		
		$status = true;
		$message = '<strong>Success!</strong> The role has been edited.';
...
<?php include("top.php");?>
           ...
           <?php }?>                           
                            ...
                            <div class="block">
                                <div class="navbar navbar-inner block-header">
                                    <div class="muted pull-left">Edit Role</div>
                                </div>
                                <div class="block-content ">
                                
                                <div style="margin-top:10px; ">
										
										<p>Here you can edit roles.</p>
                                       </div>   
  ...
  <fieldset>
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <input type="text" id="role_name" name="role_name" placeholder="" class="input-xlarge" value="<?php echo $rowRole->role_name?>">
